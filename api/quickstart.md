...
- [Authentication Guide](./authentication.md) - Auth flows and key rotation
- [Developer Integration Guide](./developer-integration-guide.md) - End-to-end build plan
- [Social Goals API](./social-goals.md) - Goal lifecycle and contributions
- [Webhooks](./webhooks.md) - Event delivery and signature verification
- [OpenAPI Spec](./openapi.yaml) - Full endpoint schema
